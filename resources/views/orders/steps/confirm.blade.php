...
<table class="table">
    <thead>
        <tr>
            <th width="5%"></th>
            <th width="50%"></th>
            <th width="15%">Price<small>(per carton)</small></th>
            <th width="15%">Quantity<small>(per carton)</small></th>
            <th width="15%">Sub Total<small>(THB)</small></th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td><a href="#"><i class="fa fa-truck fa-lg"></i></a></td>
            <td>500ml (24 per pack) One-time delivery</td>
